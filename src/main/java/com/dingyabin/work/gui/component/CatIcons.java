...
public class CatIcons {
    ...
    public static final ImageIcon tool = new ImageIcon(CatIcons.class.getResource("/icons/tool.png"));

    public static final ImageIcon windows = new ImageIcon(CatIcons.class.getResource("/icons/windows.png"));
